...
#' }
trade_summary <- function(mbp_input,
                          date,
  ...
  if (date < "2015-11-20") {
    ...
    if (length(Trade) != 0) {
      ...
      trade2 <- str_match_all(
        Trade,
        "83=([^,]*),107=([^,]*),270=([^,]*),271=([^,]*),277=([^,]*),1003=([^,]*),5797=([^,]*),"
      )
      ...
      trade3 <- str_match_all(
        Trade,
        "83=([^,]*),107=([^,]*),270=([^,]*),271=([^,]*),277=([^,]*),1003=([^,]*),"
      )
      ...
      trade2_3_all <- merge(trade2[, c("Code", "Seq", "agg")],
                            trade2_3_all,
                            by = c("Code", "Seq"),
                            all = TRUE)
    ...
    if (length(Trade) != 0) {
      ...
      trade.info <- str_match_all(trade.info,
                                  "75=([^,]*),34=([^,]*),52=([^,]*),60=([^,]*),")
      trade.info <- as.data.table(do.call(rbind, trade.info))[, -1]
